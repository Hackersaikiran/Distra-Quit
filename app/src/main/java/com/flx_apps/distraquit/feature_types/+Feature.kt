package com.flx_apps.distraquit.feature_types
...
abstract class Feature {
     ...
     * Typically, you would implement this in the [com.flx_apps.distraquit.ui.screens.feature].{feature_name} package.
     *
    ...
    /**
     * Called for each [Feature] when DistraQuit is started or when the feature is activated.
     */
    open fun onStart(context: Context) {}

    /**
     * Called for each [Feature] when DistraQuit is paused (temporarily) or stopped, or when the
