package com.flx_apps.distraquit.util
...
object NotificationHelper {
    ...
    fun areNotificationsEnabled(context: Context): Boolean {
        ...
        val isChannelEnabled =
            (context.getSystemService(Context.NOTIFICATION_SERVICE) as? NotificationManager)?.getNotificationChannel(
                DistraQuitApplication.SERVICE_CHANNEL_ID
    ...
    fun openNotificationSettings(context: Context) {
        val intent = Intent(Settings.ACTION_CHANNEL_NOTIFICATION_SETTINGS).apply {
            ...
            putExtra(Settings.EXTRA_CHANNEL_ID, DistraQuitApplication.SERVICE_CHANNEL_ID)
