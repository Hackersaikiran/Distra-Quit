package com.flx_apps.distraquit.ui.screens.permissions_required
...
import com.flx_apps.distraquit.util.ShizukuUtils
...
fun PermissionsRequiredScreenContent(
    ...
    Column(
        ...
        HyperlinkText(
            ...
            hyperLinks = listOf("https://github.com/flxapps/DistraQuit"),
