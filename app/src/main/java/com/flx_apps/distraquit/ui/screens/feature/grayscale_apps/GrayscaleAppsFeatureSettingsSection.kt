package com.flx_apps.distraquit.ui.screens.feature.grayscale_apps
...
import com.flx_apps.distraquit.features.GrayscaleAppsFeature
import com.flx_apps.distraquit.ui.screens.feature.FeatureScreenSnackbarStateProvider
import com.flx_apps.distraquit.ui.screens.feature.OpenAppExceptionsTile
import com.flx_apps.distraquit.ui.screens.feature.OpenScheduleTile
import com.flx_apps.distraquit.ui.theme.labelVerySmall
import com.flx_apps.distraquit.ui.widgets.NumberPickerDialog
...
fun AllowedDailyColorScreenTimeTile(viewModel: GrayscaleAppsFeatureSettingsViewModel = viewModel()) {
    ...
    val usedUpScreenTime = GrayscaleAppsFeature.getCurrentUsedUpScreenTime().milliseconds.inWholeMinutes.toInt()
