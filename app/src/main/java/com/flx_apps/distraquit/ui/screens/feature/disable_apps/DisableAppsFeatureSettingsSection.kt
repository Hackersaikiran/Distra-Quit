package com.flx_apps.distraquit.ui.screens.feature.disable_apps
...
import com.flx_apps.distraquit.features.DisableAppsFeature
import com.flx_apps.distraquit.features.DisableAppsMode
import com.flx_apps.distraquit.ui.screens.feature.FeatureViewModel
...
import com.flx_apps.distraquit.ui.screens.permissions_required.GrantPermissionsCommand
...
fun AllowedDailyTimeTile(
    ...
    val usedUpScreenTime = DisableAppsFeature.getCurrentUsedUpScreenTime().milliseconds.inWholeMinutes.toInt()
