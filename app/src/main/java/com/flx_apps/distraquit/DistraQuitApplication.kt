...
import com.flx_apps.distraquit.util.CachingDebugTree
import com.flx_apps.distraquit.util.InMemoryLogStore
 ...
 */
@HiltAndroidApp
class DistraQuitApplication : Application() {
    companion object {
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name = "DistraQuit Service"
            val descriptionText = "Keeps DistraQuit active in the background"
