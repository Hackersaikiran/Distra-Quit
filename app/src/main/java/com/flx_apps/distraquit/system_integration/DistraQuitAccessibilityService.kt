...
import com.flx_apps.distraquit.feature_types.OnAppOpenedSubscriptionFeature
import com.flx_apps.distraquit.feature_types.OnScrollEventSubscriptionFeature
import com.flx_apps.distraquit.features.FeaturesProvider
import com.flx_apps.distraquit.features.PauseButtonFeature
import com.flx_apps.distraquit.system_integration.DistraQuitAccessibilityService.Companion.instance
import com.flx_apps.distraquit.system_integration.DistraQuitAccessibilityService.Companion.state
import com.flx_apps.distraquit.util.BatteryOptimizationHelper
import com.flx_apps.distraquit.util.NotificationHelper
import kotlinx.coroutines.flow.MutableStateFlow
import timber.log.Timber

enum class DistraQuitState {
    /**
...
/**
 * The [DistraQuitAccessibilityService] is the main service of DistraQuit. It receives all
 ...
 */
open class DistraQuitAccessibilityService : AccessibilityService() {
    companion object {
        /**
         * The current instance of the [DistraQuitAccessibilityService]. This is set in
         ...
         */
        @JvmStatic
        var instance: DistraQuitAccessibilityService? = null
         ...
         * @see DistraQuitState
         */
        val state: MutableStateFlow<DistraQuitState> = MutableStateFlow(DistraQuitState.Inactive)

        /**
         * Updates the [state] of the service (and returns it).
         */
        fun updateState(): DistraQuitState {
            state.value = when {
                instance == null -> DistraQuitState.Inactive
                PauseButtonFeature.isPausing() -> DistraQuitState.Paused
                else -> DistraQuitState.Active
            }
            return state.value
        }
    }
    ...
    /**
     * The view model/logic holder for the [DistraQuitAccessibilityService].
    ...
    override fun onCreate() {
        Timber.i("DistraQuitAccessibilityService: onCreate")
        super.onCreate()
        instance = this
        ...
        Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
            Timber.e(
                throwable,
                "DistraQuitAccessibilityService: Uncaught Exception on thread ${thread.name}"
            )
    ...
    override fun onServiceConnected() {
        Timber.i("DistraQuitAccessibilityService: onServiceConnected")
    ...
    /**
     * Called when the service is interrupted. This is not used by DistraQuit (however, [onDestroy]
     * is used to handle all cleanup operations).
     */
    override fun onInterrupt() {
        Timber.w("DistraQuitAccessibilityService: onInterrupt")
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Timber.i("DistraQuitAccessibilityService: onStartCommand flags=$flags startId=$startId")
        return START_STICKY
    }

    override fun onTaskRemoved(rootIntent: Intent?) {
        Timber.i("DistraQuitAccessibilityService: onTaskRemoved")
        super.onTaskRemoved(rootIntent)
    }

    override fun onLowMemory() {
        Timber.w("DistraQuitAccessibilityService: onLowMemory")
        super.onLowMemory()
    }

    override fun onTrimMemory(level: Int) {
        Timber.w("DistraQuitAccessibilityService: onTrimMemory level=$level")
    ...
    override fun onDestroy() {
        Timber.i("DistraQuitAccessibilityService: onDestroy")
        super.onDestroy()
    ...
    private fun startForegroundService() {
        ...
        val pauseIntent = Intent(this, PauseInteractionService::class.java).apply {
            action = "com.flx_apps.distraquit.ACTION_PAUSE"
        }
        ...
        val notification: Notification =
            NotificationCompat.Builder(this, DistraQuitApplication.SERVICE_CHANNEL_ID)
